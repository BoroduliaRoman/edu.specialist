...
public class Program {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		Files.readAllLines(Paths.get("..", filename)).forEach(out::println);
		
		Path dir = Paths.get("..");
		
//		Paths.get(".");
		Files.newDirectoryStream(dir).forEach(out::println);
...
//		key.pollEvents().stream().forEach(e -> out.println(((Path)e.context()).getFileName()));
